...
export type FilterTypeDescriptor = {
  ...
  createDefault: (base: { id: string; field: string }, field: DsFilterableField) => DsQueryFilter;
  renderRow: (
  ...
  formatChip: (filter: DsQueryFilter, field: DsFilterableField | undefined) => string;
};
